"""
Django settings for useitnu project.
...
SECRET_KEY = 'django-insecure-h+@x5p!!^rehizzi-wjhzj@m_bm+10(y+&95mwk%^%-qf9i!(9'
...
WSGI_APPLICATION = 'useitnu.wsgi.application'
